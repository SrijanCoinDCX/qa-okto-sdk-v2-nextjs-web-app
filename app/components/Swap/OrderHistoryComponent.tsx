...
import { ChevronDown, ChevronUp, ArrowRight, Check, X, ExternalLink, Filter, HexagonIcon, ActivityIcon, XCircle, Loader2 } from 'lucide-react';
import { useOkto, getOrdersHistory, Order, OrderDetails } from '@okto_web3/react-sdk';

interface ExtendedOrder extends Order {
    intentId: string;
    intentType: 'SWAP' | 'TOKEN_TRANSFER';
                    ...
                    <div className="flex flex-wrap gap-3 mt-6">
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                {selectedIntentType ? 
                                    `${selectedIntentType === 'SWAP' ? 'Swaps' : 'Transfers'}` : 
                                    'Filter by Type'
                                }
                ...
                {selectedIntentType && (
                    <div className="mx-6 my-4 px-4 py-2 bg-yellow-500 bg-opacity-20 rounded-lg text-sm flex justify-between items-center border border-yellow-600 border-opacity-30">
                        <span className="text-yellow-300 flex items-center gap-2">
                            <HexagonIcon size={16} />
                            Showing {selectedIntentType === 'SWAP' ? 'token swaps' : 'token transfers'} only
                        </span>
                        <button 
                ...
                <div className="p-6 space-y-4">
                    {isLoading ? (
                        ...
                        <div className="text-center p-12 text-gray-400 bg-gray-800 rounded-lg border border-dashed border-gray-700">
                            ...
                            {selectedIntentType 
                                ? `No ${selectedIntentType === 'SWAP' ? 'swap' : 'transfer'} transactions found` 
                            ...
                            >
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-white flex items-center gap-2">
                                                {tx.intentType === 'SWAP' ? 'Token Swap' : 'Token Transfer'}
                                ...
                                {expandedId === tx.intentId && (
                                    <div className="p-4 bg-gray-900 border-t border-gray-700 space-y-4">
                                        ...
                                        {/* Transfer Details */}
                                        {tx.intentType === 'TOKEN_TRANSFER' && tx.details && (
